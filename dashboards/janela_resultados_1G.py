...
class Ui_resultados_1G(object):
    def setupUi(self, resultados_1G):
        if not resultados_1G.objectName():
            resultados_1G.setObjectName(u"resultados_1G")
        resultados_1G.resize(1033, 531)
        resultados_1G.setStyleSheet(u"background-color: rgb(52, 73, 94);")
...
"")
        ...
        self.fluxos_angulares.setObjectName(u"fluxos_angulares")
        ...
        self.fluxos_angulares.setStyleSheet(u"font: 10pt \"Roboto\";\n"
...
"}")
        ...
        self.grafico.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.grafico_intensidade = QGraphicsView(self.groupBox_6)
        self.grafico_intensidade.setObjectName(u"grafico_intensidade")
        self.grafico_intensidade.setGeometry(QRect(20, 410, 501, 41))
        self.grafico_intensidade.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.cor_maximo = QGraphicsView(self.groupBox_6)
        self.cor_maximo.setObjectName(u"cor_maximo")
        self.cor_maximo.setGeometry(QRect(20, 460, 31, 31))
        self.cor_maximo.setStyleSheet(u"background-color: rgb(255, 255, 255);")
...
"font: 500 10pt \"Roboto\";")
        ...
        self.cor_minimo.setObjectName(u"cor_minimo")
        self.cor_minimo.setGeometry(QRect(150, 460, 31, 31))
        self.cor_minimo.setStyleSheet(u"background-color: rgb(255, 255, 255);")
...
"font: 500 10pt \"Roboto\";")
        ...
        self.ampliar_grafico.setObjectName(u"ampliar_grafico")
        ...
        self.ampliar_grafico.setStyleSheet(u"color: white;\n"
...
"}")
        ...
        self.fluxos_escalares.setObjectName(u"fluxos_escalares")
        self.fluxos_escalares.setGeometry(QRect(10, 30, 431, 101))
        self.fluxos_escalares.setFont(font1)
        self.fluxos_escalares.setStyleSheet(u"font: 10pt \"Roboto\";\n"
"background-color: rgb(255, 255, 255);")
        self.taxas = QPushButton(resultados_1G)
        self.taxas.setObjectName(u"taxas")
        self.taxas.setGeometry(QRect(170, 480, 111, 31))
        self.taxas.setStyleSheet(u"color: white;\n"
"font: 500 10pt \"Roboto\";")
...
"}")
        ...
        self.iteracoes_1g.setObjectName(u"iteracoes_1g")
        ...
        self.iteracoes_1g.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"font: 700 12pt \"Roboto\";")
...
"}")
        ...
        self.duracao_calculo.setObjectName(u"duracao_calculo")
        ...
        self.duracao_calculo.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"font: 700 12pt \"Roboto\";")
    ...
    def retranslateUi(self, resultados_1G):
        resultados_1G.setWindowTitle(QCoreApplication.translate("resultados_1G", u"Resultados - 1 Grupo", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("resultados_1G", u"Fluxos Angulares", None))
        ___qtablewidgetitem = self.fluxos_angulares.verticalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("resultados_1G", u"1", None));
        ___qtablewidgetitem1 = self.fluxos_angulares.verticalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("resultados_1G", u"2", None));
        ___qtablewidgetitem2 = self.fluxos_angulares.verticalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("resultados_1G", u"3", None));
        ___qtablewidgetitem3 = self.fluxos_angulares.verticalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("resultados_1G", u"4", None));
        self.groupBox_6.setTitle(QCoreApplication.translate("resultados_1G", u"Fluxo Escalar de n\u00eautrons no dom\u00ednio", None))
        self.label_20.setText(QCoreApplication.translate("resultados_1G", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">M\u00e1ximo</span></p></body></html>", None))
        self.label_21.setText(QCoreApplication.translate("resultados_1G", u"<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">M\u00ednimo</span></p></body></html>", None))
        self.ampliar_grafico.setText(QCoreApplication.translate("resultados_1G", u"Ampliar Gr\u00e1fico", None))
        self.groupBox.setTitle(QCoreApplication.translate("resultados_1G", u"Fluxos Escalares", None))
        ___qtablewidgetitem4 = self.fluxos_escalares.verticalHeaderItem(0)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("resultados_1G", u"Fluxos", None));
        ___qtablewidgetitem5 = self.fluxos_escalares.verticalHeaderItem(1)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("resultados_1G", u"X (cm)", None));
        self.taxas.setText(QCoreApplication.translate("resultados_1G", u"Mostrar Taxas", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("resultados_1G", u"N\u00famero de Itera\u00e7\u00f5es", None))
        self.iteracoes_1g.setText(QCoreApplication.translate("resultados_1G", u"0", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("resultados_1G", u"Dura\u00e7\u00e3o do C\u00e1lculo (s):", None))
        self.duracao_calculo.setText(QCoreApplication.translate("resultados_1G", u"0", None))
    # retranslateUi
